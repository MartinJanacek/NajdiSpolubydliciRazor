...
{
    [BindProperties]
    public class RemoveOfferModel : PageModel
    {
        ...
        public RemoveOfferModel(ApplicationDbContext context, IEmailSender emailSender, IOneTimeCode oneTimeCode, IHasher hasher)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            if (Type == TypeOfAdvertising.Offer)
            {
                ...
                return RedirectToPage($"/Offer/VerifyEmail", new { id = offerEntity.Id, after = AfterVerification.Delete });
            }
            if (Type == TypeOfAdvertising.Demand)
            {
                ...
                return RedirectToPage("/Demand/VerifyEmail", new { id = demandEntity.Id, after = AfterVerification.Delete });
            }
